...
export declare class CfnCacheCluster extends cdk.CfnResource implements cdk.IInspectable, ICacheClusterRef, cdk.ITaggable {
     ...
     */
    static fromClusterName(scope: constructs.Construct, id: string, clusterName: string): ICacheClusterRef;
    static arnForCacheCluster(resource: ICacheClusterRef): string;
    /**
